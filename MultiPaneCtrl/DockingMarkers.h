...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
#if (!defined(_MSC_VER) && __cplusplus < 201103L) || (defined(_MSC_VER) && _MSC_VER < 1700)   // C++11 is not supported.
	#define nullptr  NULL
	#define override
#endif
/////////////////////////////////////////////////////////////////////////////
...
struct TAO_DLLIMPEXP DockingMarkers
{
///////////////////////////////////////
// PUBLIC
///////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
//
struct TAO_DLLIMPEXP DockingMarkersDrawBase : DockingMarkers::Draw
{		// DockingMarkers::Draw.
...
/////////////////////////////////////////////////////////////////////////////
//
struct TAO_DLLIMPEXP DockingMarkersDraw_custom1 : DockingMarkersDrawBase
...
/////////////////////////////////////////////////////////////////////////////
//
struct TAO_DLLIMPEXP DockingMarkersDraw_VS2003 : DockingMarkersDrawBase
{	int GetInsertionFrameWidth(DockingMarkers * /*markers*/) override { return 8; }
};
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP DockingMarkersDraw_VS2005 : DockingMarkersDrawBase
{	int GetInsertionWindowBorderWidth(DockingMarkers * /*markers*/) override { return 2; }
};
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP DockingMarkersDraw_VS2008 : DockingMarkersDrawBase
{
};
/////////////////////////////////////////////////////////////////////////////
//
struct TAO_DLLIMPEXP DockingMarkersDraw_VS2010 : DockingMarkersDrawBase
{	int GetInsertionWindowBorderWidth(DockingMarkers *markers) override;
