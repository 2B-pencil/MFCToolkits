...
class TAO_DLLIMPEXP CGridCtrl : public CWnd
{
...
///////////////////////////////////////////////////////////////////////////////////
public:
    void  RowOnlyRead(int nRow);
	void RowIsEpt(int iRow, int Cols, int& Flag);//has
	BOOL IsEpt(int i, int j);//has
...
public:
	...
	BOOL GetCellType(int nRow, int nCol);
	BOOL SetCellTypeForcheckbox(int nRow, int nCol, BOOL TorF);
