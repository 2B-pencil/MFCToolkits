...
class TAO_DLLIMPEXP CDateTimeCtrl;
#else
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CGridColumnTraitDateTime : public CGridColumnTraitImage
{
public:
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CGridEditorDateTimeCtrl : public CDateTimeCtrl
{
