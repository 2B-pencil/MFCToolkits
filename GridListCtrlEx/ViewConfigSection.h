...
template class TAO_DLLIMPEXP CSimpleMap<CString, CString>;
#else
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CViewConfigSection
{
protected:
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CViewConfigSectionDefault : public CViewConfigSection
{
protected:
	//! Inner class that stores the default configuration in memory
	class TAO_DLLIMPEXP CViewConfigSectionLocal : public CViewConfigSection
	{
	protected:
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CViewConfigSectionProfiles : public CViewConfigSectionDefault
{
protected:
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CViewConfigSectionWinApp : public CViewConfigSectionProfiles
{
protected:
