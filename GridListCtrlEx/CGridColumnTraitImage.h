...
template class TAO_DLLIMPEXP CSimpleMap<int, CString>;
template class TAO_DLLIMPEXP CSimpleMap<int, bool>;
#else
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CGridColumnTraitImage : public CGridColumnTraitText
{
public:
