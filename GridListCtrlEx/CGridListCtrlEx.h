...
//        New define _TAOCOMMONLIB_ that makes it easier to create MFC Extension DLL
...
class TAO_DLLIMPEXP CListCtrl;
class TAO_DLLIMPEXP CFont;
class TAO_DLLIMPEXP CTime;
class CGridColumnTrait;
template class TAO_DLLIMPEXP CSimpleArray<CGridColumnTrait*>;
#else
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CGridListCtrlEx : public CListCtrl
{
