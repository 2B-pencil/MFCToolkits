...
template class TAO_DLLIMPEXP CSimpleMap<DWORD_PTR, CString>;
#else
template class TAO_DLLIMPEXP CSimpleMap<DWORD, CString>;
#endif
class TAO_DLLIMPEXP CEdit;
class TAO_DLLIMPEXP CComboBox;
#else
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CGridColumnTraitCombo : public CGridColumnTraitImage
{
public:
...
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CGridEditorComboBoxEdit : public CEdit
{
...
// http://www.codeproject.com/KB/miscctrl/gridctrl.aspx
//------------------------------------------------------------------------
class TAO_DLLIMPEXP CGridEditorComboBox : public CComboBox
{
