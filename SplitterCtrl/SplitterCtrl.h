...
class TAO_DLLIMPEXP SplitterCtrl : public CWnd
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP SplitterCtrlStyle1 : 
	SplitterCtrl::Draw,
...
/////////////////////////////////////////////////////////////////////////////
// 
class TAO_DLLIMPEXP SplitterCtrlStyle7 : public SplitterCtrlStyle1
{		// SplitterCtrl::Draw.
	void DrawSplitter(SplitterCtrl const *ctrl, CDC *dc, bool horz, int idx, CRect const *rect) override;
	void DrawEnd(SplitterCtrl const *ctrl, CDC *dc) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
class TAO_DLLIMPEXP SplitterCtrlStyle8 : public SplitterCtrlStyle1
{		// SplitterCtrl::Draw.
	void DrawSplitter(SplitterCtrl const *ctrl, CDC *dc, bool horz, int idx, CRect const *rect) override;
	void DrawBorder(SplitterCtrl const *ctrl, CDC *dc, CRect const *rect) override;
	void DrawEnd(SplitterCtrl const *ctrl, CDC *dc) override;
