...
/////////////////////////////////////////////////////////////////////////////
// 
class TAO_DLLIMPEXP TabCtrl : public CWnd
...
/////////////////////////////////////////////////////////////////////////////
// 
interface TAO_DLLIMPEXP ITabCtrlStyle
...
/////////////////////////////////////////////////////////////////////////////
//
struct TAO_DLLIMPEXP TabCtrlStyle_base :
	ITabCtrlStyle,
	TabCtrl::Draw, 
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2003_base : TabCtrlStyle_base
{		// TabCtrl::Draw.
	void DrawButtonClose(TabCtrl const *ctrl, CDC *dc, CRect const *rect, bool hover, bool pushed) override;
	void DrawButtonMenu(TabCtrl const *ctrl, CDC *dc, CRect const *rect, bool hover, bool pushed, bool partialView) override;
	void DrawButtonScrollLeft(TabCtrl const *ctrl, CDC *dc, CRect const *rect, bool hover, bool pushed, bool partialView) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2003_client : TabCtrlStyle_VS2003_base
{		// TabCtrl::IRecalc.
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2003_client_custom1 : TabCtrlStyle_VS2003_client
{		// TabCtrl::Draw.
	void DrawButtonClose(TabCtrl const *ctrl, CDC *dc, CRect const *rect, bool hover, bool pushed) override;
	void DrawButtonMenu(TabCtrl const *ctrl, CDC *dc, CRect const *rect, bool hover, bool pushed, bool partialView) override;
	void DrawButtonScrollLeft(TabCtrl const *ctrl, CDC *dc, CRect const *rect, bool hover, bool pushed, bool partialView) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2003_bars : TabCtrlStyle_VS2003_base
{		// TabCtrl::IRecalc.
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2003_bars_custom1 : TabCtrlStyle_VS2003_bars
{		// TabCtrl::IRecalc.
	CRect GetControlAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetWindowsAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_client_base : TabCtrlStyle_base
{		// TabCtrl::IRecalc.
	int GetBorderWidth(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetControlAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetWindowsAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_client_classic : TabCtrlStyle_VS2008_client_base
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_client_blue : TabCtrlStyle_VS2008_client_base
{		// TabCtrlStyle_VS2008_client_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool active, bool disable) override;
	COLORREF GetTabOutlineColor(TabCtrl const *ctrl, bool active, bool hover, bool disable, bool left) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool active, bool hover, bool disable) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_client_silver : TabCtrlStyle_VS2008_client_base
{		// TabCtrlStyle_VS2008_client_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool active, bool disable) override;
	COLORREF GetTabOutlineColor(TabCtrl const *ctrl, bool active, bool hover, bool disable, bool left) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool active, bool hover, bool disable) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_client_olive : TabCtrlStyle_VS2008_client_base
{		// TabCtrlStyle_VS2008_client_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool active, bool disable) override;
	COLORREF GetTabOutlineColor(TabCtrl const *ctrl, bool active, bool hover, bool disable, bool left) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool active, bool hover, bool disable) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_base : TabCtrlStyle_base
{		// TabCtrl::IRecalc.
	int GetBorderWidth(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetControlAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetTabPadding(TabCtrl const *ctrl, IRecalc *base) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_classic : TabCtrlStyle_VS2008_bars_base
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_blue : TabCtrlStyle_VS2008_bars_base
{		// TabCtrlStyle_VS2008_bars_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool hover) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool hover, bool disable) override;
	COLORREF GetTabGradientDarkColor(TabCtrl const *ctrl, bool hover, bool disable) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_silver : TabCtrlStyle_VS2008_bars_base
{		// TabCtrlStyle_VS2008_bars_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool hover) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool hover, bool disable) override;
	COLORREF GetTabGradientDarkColor(TabCtrl const *ctrl, bool hover, bool disable) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_olive : TabCtrlStyle_VS2008_bars_base
{		// TabCtrlStyle_VS2008_bars_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool hover) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool hover, bool disable) override;
	COLORREF GetTabGradientDarkColor(TabCtrl const *ctrl, bool hover, bool disable) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_custom1_base : TabCtrlStyle_VS2008_bars_base
{		// TabCtrl::IRecalc.
	CRect GetControlAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetWindowsAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_classic_custom1 : TabCtrlStyle_VS2008_bars_custom1_base
{		// TabCtrlStyle_VS2008_bars_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool hover) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool hover, bool disable) override;
	COLORREF GetTabGradientDarkColor(TabCtrl const *ctrl, bool hover, bool disable) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_blue_custom1 : TabCtrlStyle_VS2008_bars_custom1_base
{		// TabCtrlStyle_VS2008_bars_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool hover) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool hover, bool disable) override;
	COLORREF GetTabGradientDarkColor(TabCtrl const *ctrl, bool hover, bool disable) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_silver_custom1 : TabCtrlStyle_VS2008_bars_custom1_base
{		// TabCtrlStyle_VS2008_bars_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool hover) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool hover, bool disable) override;
	COLORREF GetTabGradientDarkColor(TabCtrl const *ctrl, bool hover, bool disable) override;
...
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2008_bars_olive_custom1 : TabCtrlStyle_VS2008_bars_custom1_base
{		// TabCtrlStyle_VS2008_bars_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl, bool hover) override;
	COLORREF GetTabGradientLightColor(TabCtrl const *ctrl, bool hover, bool disable) override;
	COLORREF GetTabGradientDarkColor(TabCtrl const *ctrl, bool hover, bool disable) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2010_client : TabCtrlStyle_base
{		// TabCtrl::IRecalc.
	int GetBorderWidth(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetControlAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetWindowsAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2010_client_custom1 : TabCtrlStyle_VS2010_client
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2010_client_custom2 : TabCtrlStyle_VS2010_client
{		// TabCtrlStyle_VS2010_client.
	void DrawTabBack(TabCtrl const *ctrl, CDC *dc, TabCtrl::HTAB tab, CRect const *rect, CRgn *rgn) override;
	void DrawWindowsAreaBack(TabCtrl const *ctrl, CDC *dc, CRect const *rect) override;
};
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2019_client_base : TabCtrlStyle_base
{		// TabCtrl::IRecalc.
	int GetBorderWidth(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetControlAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetWindowsAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2019_client_light : TabCtrlStyle_VS2019_client_base
{		// TabCtrlStyle_base.
	COLORREF GetCtrlAreaBackColor(TabCtrl const *ctrl) override;
	COLORREF GetTabTextColor(TabCtrl const *ctrl, TabCtrl::HTAB tab) override;
	COLORREF GetButtonCloseColor(TabCtrl const *ctrl, bool hover, bool pushed) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2019_client_light_custom1 : TabCtrlStyle_VS2019_client_light
{	CRect GetControlAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
};
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2019_client_dark : TabCtrlStyle_VS2019_client_base
{		// TabCtrlStyle_base.
	COLORREF GetCtrlAreaBackColor(TabCtrl const *ctrl) override;
	COLORREF GetTabTextColor(TabCtrl const *ctrl, TabCtrl::HTAB tab) override;
	COLORREF GetButtonCloseColor(TabCtrl const *ctrl, bool hover, bool pushed) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2019_client_blue : TabCtrlStyle_VS2019_client_base
{		// TabCtrl::IRecalc.
	int GetBorderWidth(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetControlAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetWindowsAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2019_bars_base : TabCtrlStyle_base
{		// TabCtrl::IRecalc.
	int GetBorderWidth(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetControlAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetWindowsAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2019_bars_light : TabCtrlStyle_VS2019_bars_base
{		// TabCtrlStyle_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl) override;
	COLORREF GetCtrlAreaBackColor(TabCtrl const *ctrl) override;
	COLORREF GetTabSelectedBackColor(TabCtrl const *ctrl) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2019_bars_dark : TabCtrlStyle_VS2019_bars_base
{		// TabCtrlStyle_base.
	COLORREF GetTabBorderColor(TabCtrl const *ctrl) override;
	COLORREF GetCtrlAreaBackColor(TabCtrl const *ctrl) override;
	COLORREF GetTabSelectedBackColor(TabCtrl const *ctrl) override;
...
/////////////////////////////////////////////////////////////////////////////
// 
struct TAO_DLLIMPEXP TabCtrlStyle_VS2019_bars_blue : TabCtrlStyle_VS2019_bars_base
{		// TabCtrl::IRecalc.
	int GetBorderWidth(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetWindowsAreaPadding(TabCtrl const *ctrl, IRecalc *base) override;
	CRect GetTabPadding(TabCtrl const *ctrl, IRecalc *base) override;
...
struct TAO_DLLIMPEXP TabCtrlEx : TabCtrl
{	TabCtrlEx()
	{	style.Install(this);
	}
	CLASS_STYLE style;
